...
from groq import AsyncGroq # <-- DIUBAH
...
from .crypto_handler import register_crypto_handler # <-- Tambahkan ini
from .sticker_handler import register_sticker_handler # <-- Tambahkan ini
from .ai_handler import register_ai_handler # <-- Tambahkan ini




def register_all_handlers(app: Client, group_call, locales: LocalizationManager, user_settings: dict, db_manager: DatabaseManager, groq_client: AsyncGroq):
    ...
    register_crypto_handler(app, locales, user_settings) # <-- Tambahkan ini
    register_sticker_handler(app, locales, user_settings) # <-- Tambahkan ini
    register_ai_handler(app, locales, user_settings, db_manager, groq_client)
